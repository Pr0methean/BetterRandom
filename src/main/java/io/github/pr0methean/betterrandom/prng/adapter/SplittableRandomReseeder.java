...
public final class SplittableRandomReseeder {
  ...
  @Nullable private static MethodHandle PUT_VOLATILE_LONG;
  ...
  static {
    try {
      ...
      GOLDEN_GAMMA = (long) SplittableRandom.class.getDeclaredField("GOLDEN_GAMMA").get(null);
      ...
      PUT_VOLATILE_LONG = MethodHandles.lookup().unreflect(putVolatileLong).bindTo(unsafe);
