...
open class MersenneTwisterRandomTest : BaseRandomTest() {

    protected override val classUnderTest: Class<out BaseRandom>
        get() = MersenneTwisterRandom::class.java

    @Throws(SeedException::class)
    override fun createRng(): BaseRandom {
        return MersenneTwisterRandom(testSeedGenerator)
    }

    @Throws(SeedException::class)
    override fun createRng(seed: ByteArray?): BaseRandom {
        return MersenneTwisterRandom(seed)
    }
}
