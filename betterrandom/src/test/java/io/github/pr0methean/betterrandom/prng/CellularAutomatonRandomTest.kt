...
class CellularAutomatonRandomTest : BaseRandomTest() {

    protected override val classUnderTest: Class<out BaseRandom>
        get() = CellularAutomatonRandom::class.java
    ...
    override fun createRng(): BaseRandom {
        return CellularAutomatonRandom(testSeedGenerator)
    }

    @Throws(SeedException::class)
    override fun createRng(seed: ByteArray?): BaseRandom {
        return CellularAutomatonRandom(seed)
    }
}
