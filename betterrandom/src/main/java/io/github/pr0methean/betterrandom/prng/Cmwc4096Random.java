 ...
 * (2^131104).  It should be used in preference to the {@link io.github.pr0methean.betterrandom.prng.MersenneTwisterRandom} when a very
 ...
 * seed this RNG using the {@link #setSeed(long)} method inherited from {@link java.util.Random}.  Calls to
