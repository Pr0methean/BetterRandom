 ...
 * drops too low. Reseeding is done on a {@link RandomSeeder} if provided, and on the calling
...
public class EntropyBlockingSplittableRandomAdapter extends SplittableRandomAdapter {
   ...
   * Creates an instance.
   *
   * @param randomSeeder the {@link RandomSeeder} that will reseed this. Its seed
  ...
  public EntropyBlockingSplittableRandomAdapter(
      RandomSeeder randomSeeder, long minimumEntropy) {
   ...
   * @param randomSeeder the {@link RandomSeeder} that will reseed this
   * @param minimumEntropy the minimum entropy; operations that would drop the entropy below this
   *     amount will instead block until the calling thread's PRNG is reseeded. Should generally
   *     be zero or negative.
   */
  public EntropyBlockingSplittableRandomAdapter(
      @Nullable SeedGenerator seedGenerator, RandomSeeder randomSeeder, long minimumEntropy) {
