...
import io.github.pr0methean.betterrandom.util.BinaryUtils.convertIntToBytes
...
class CellularAutomatonRandom : BaseRandom {
    ...
    companion object {
        ...
        private val serialVersionUID = 5959251752288589909L
        private val SEED_SIZE_BYTES = 4
        private val AUTOMATON_LENGTH = 2056
        val EVOLVE_ITERATIONS_AFTER_SEEDING = AUTOMATON_LENGTH * AUTOMATON_LENGTH / 4
        val LAST_CELL_INDEX = AUTOMATON_LENGTH - 1
