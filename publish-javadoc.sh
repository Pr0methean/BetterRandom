...
cd docs
find . -iname "*.html" -exec sed -i 's/<head>/<head><script async src="https:\/\/www.googletagmanager.com\/gtag\/js?id=UA-106545233-1"><\/script><script>window.dataLayer = window.dataLayer || []; function gtag(){dataLayer.push(arguments)}; gtag('js', new Date()); gtag('config', 'UA-106545233-1');<\/script>/' {} \;
git add .
